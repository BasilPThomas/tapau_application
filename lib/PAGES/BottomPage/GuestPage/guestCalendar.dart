...
import 'package:tapau_application/PAGES/BottomPage/GuestPage/payment.dart';
import 'package:http/http.dart' as http;

class GuestCalender extends StatefulWidget {
  @override
  _GuestCalenderState createState() => _GuestCalenderState();
}

class _GuestCalenderState extends State<GuestCalender> {
  Future<http.Response> fetchPost() {
    return http.post('https://jsonplaceholder.typicode.com/posts/guestCalender',);
  }
