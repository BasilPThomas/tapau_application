...
import 'package:tapau_application/PAGES/BottomPage/Home/2inOneCombo/deliveryDetails.dart';
import 'package:http/http.dart' as http;

class TwoInOne extends StatefulWidget {
  @override
  _TwoInOneState createState() => _TwoInOneState();
}
...
class _TwoInOneState extends State<TwoInOne> with SingleTickerProviderStateMixin {
  Future<http.Response> fetchPost() {
    return http.post('https://jsonplaceholder.typicode.com/posts/twoInOne',);
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: PreferredSize(
        ...
        child: AppBar(
          title: Text("2 in One Combo",style: TextStyle(fontSize: 22,fontFamily: 'Poppins-SemiBold',),textAlign: TextAlign.end,),
