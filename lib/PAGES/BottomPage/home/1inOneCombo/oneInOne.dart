...
import 'package:tapau_application/PAGES/BottomPage/home/1inOneCombo/deliveryDetails.dart';
import 'package:http/http.dart' as http;

class OneInOne extends StatefulWidget {
  OneInOne({Key key}) : super(key: key);
  @override
  _OneInOneState createState() => _OneInOneState();
}
...
class _OneInOneState extends State<OneInOne> with SingleTickerProviderStateMixin {
  Future<http.Response> fetchPost() {
    return http.post('https://jsonplaceholder.typicode.com/posts/oneinone',);
  }
  ...
  Widget _dropdownVaules() {
    return  Container(
      ...
      padding: EdgeInsets.only(left: 40.0,right: 40,top: 2,bottom: 2),
    ...
    return SizedBox(
      ...
      child: Column(
        children: [
          Row(
            children: [
              Text("1 in 1 Meal Pack", style: TextStyle(fontSize: 21, fontFamily:'Poppins',fontWeight: FontWeight.bold),),
              SizedBox(width: 20,),
              _dropdownVaules(),
            ],
          ),
    ...
    return Scaffold(
      appBar: PreferredSize(
        ...
        child: AppBar(
          title: Align(
              alignment: Alignment.bottomLeft,
              child: Text("1 in One Combo",style: TextStyle(fontSize: 22,fontFamily: 'Poppins-SemiBold',))),
