...
import 'package:tapau_application/PAGES/DrawerPage/MealPlannerPage/payment.dart';
...
class _MealPlannerState extends State<MealPlanner> {
  Future<http.Response> fetchPost() {
    return http.post('https://jsonplaceholder.typicode.com/posts/mealPlanner',);
  }
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Container(
                  ...
                  child: Text("5 Days Subscription Remaining",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 20,color: Colors.pink[900]),textAlign: TextAlign.center,)),
              Container(
                decoration: BoxDecoration(
                    borderRadius: BorderRadius.all(Radius.circular(40)),
                    boxShadow: <BoxShadow>[
